...
```{r}
plot_bar +
  scale_fill_manual(values = c("cyan", "lightgreen", "yellow"))

plot_jitter +
  scale_color_manual(values = c("magenta", "tomato", 
                                "lightskyblue"))
```
...
```{r}
plot_bar +
  scale_fill_manual(values = c("Torgersen" = "darkorange",
                               "Biscoe" = "cyan4",
                               "Dream" = "purple"))
plot_jitter +
  scale_color_manual(values = c("Torgersen" = "darkorange",
                               "Biscoe" = "cyan4",
                               "Dream" = "purple"))
```
...
```{r}
plot_hex +
  scale_fill_gradient2(low = "red", mid = "grey", high = "yellow",midpoint = 200)
```
...
plot_jitter +
  scale_color_manual(values = c("Torgersen" = "red",
                                "Biscoe" = "blue",
                                "Dream" = "green"))
```
...
```{r}
plot_hex +
    scale_fill_gradientn(colors = brewer.pal(n = 7, name = 'RdPu'))
plot_jitter +
...
```{r}
demoplot(sequential_hcl(n = 3, palette = "Sunsetdark"), "bar")
demoplot(sequential_hcl(n = 3, palette = "Libson"), "scatter")
demoplot(sequential_hcl(n = 3, palette = "Harmonic"), "lines")
```
...
brewer_colors <- brewer.pal(4, "Set2")
