...
Generally, penguins with greater flipper length tend to have greater bill length resulting in a positive correlation (as the flipper length increases, the bill length also increases).
...
--
prediction here
I could observe two clusters. One cluster could be male penguins which would be bigger and at the top and the other cluster would be female penguins at the bottom.
